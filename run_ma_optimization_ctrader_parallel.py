#!/usr/bin/env python3
"""
Parallel version of MA optimization script for cTrader.
...
def main():
    """Run parallel MA optimization with real cTrader data"""
    print("🚀 PARALLEL MA OPTIMIZATION WITH CTRADER DATA")
    print("=" * 50)
    ...
    # long_window_range = [100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250]
